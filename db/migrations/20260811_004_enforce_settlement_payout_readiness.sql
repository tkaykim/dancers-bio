-- Final database guard for the settlement withdrawal/payment pipeline.
-- Production was updated before the application rollout; this migration keeps
-- the repository schema history aligned with that live state.
...
begin
  if new.status not in (
    'requested'::public.settlement_status,
