...
const T: Record<Lang, Copy> = {
  en: {
    ...
    lead: "Tick what you want now. What you pay up front is part of the later cost, not an extra charge.",
    auditionName: "Audition · level test",
    auditionDesc: "Confirms your seat. Part of the program cost, not an extra charge.",
    ...
    estimateNote: "What you pay now is already discounted from these amounts.",
  ...
  ja: {
    title: "必要なものを選んでください",
    lead: "今回申し込むものにチェックしてください。先にお支払いいただく分は後の費用に含まれており、追加のご負担ではありません。",
    auditionName: "オーディション・レベルテスト",
    auditionDesc: "参加を確定します。プログラム費用に含まれ、追加負担ではありません。",
    ...
    payNow: "今回のお支払い",
    estimate: "進める場合の想定総額",
    estimateNote: "今回お支払いいただく分は、この金額からすでに割引されています。",
  ...
  ko: {
    title: "필요한 것을 선택하세요",
    lead: "지금 신청할 항목을 체크해 주세요. 먼저 내시는 금액은 나중 비용에 포함된 것이라 더 내시는 돈이 아닙니다.",
    auditionName: "오디션·레벨테스트",
    auditionDesc: "참석을 확정합니다. 프로그램 비용에 포함된 금액입니다.",
    ...
    payNow: "지금 결제할 금액",
    estimate: "진행 시 예상 총액",
    estimateNote: "지금 결제하신 금액은 이 금액에서 이미 할인되어 있습니다.",
