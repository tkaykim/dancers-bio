...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    price: "Estimated base fee: about ₩4,000,000",
    priceDetail: "The final amount may change after consultation, depending on your visa route, training needs, and optional support.",
    ...
    consultation: "Choose three online meeting time options",
    ...
    priceAck: "I understand that ₩4,000,000 is an estimated base fee and the final amount may change after consultation.",
  ...
  ja: {
    ...
    priceDetail: "ビザ経路、トレーニング、追加サポートの範囲により、最終費用は相談後に変わる場合があります。",
    ...
    consultation: "オンライン相談が可能な日時を3つ選んでください。",
    ...
    priceAck: "400万ウォンは基本目安料金であり、相談後に最終費用が変わる可能性があることを理解しました。",
  ...
  ko: {
    ...
    consultation: "온라인 미팅 가능한 날짜와 시간을 3개 선택해 주세요.",
    ...
    priceAck: "400만원은 기본 안내 단가이며, 상담 후 최종 비용이 달라질 수 있다는 점을 이해했습니다.",
