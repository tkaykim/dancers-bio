...
const T: Record<Lang, Copy> = {
  ...
  ja: {
    ...
    steps: [
      ...
      { title: "お仕事へ", body: "deetz経由でキャスティング — 契約はきちんと書面で。" },
    ],
    protectTitle: "ダンサーを守ります",
    protectBody: "この業界には未払いの問題があります。deetzはそれを変えるために作られ、プログラムも同じルールで動きます：",
    protectPoints: [
      "すべての案件で書面契約 — ギャラ・スケジュール・NDA条件を明記（契約主体はGRIGO Entertainment）。",
      "費用は透明に — 決める前に、何にいくらかかるかを明確に説明。",
    ...
    faqs: [
      ...
      { q: "どのくらいのレベルが必要ですか？", a: "すべての応募を審査します — レベル・伸びしろ・目標。完成したプロである必要はありません。本気であることが条件です。" },
  ...
  ko: {
    ...
    pillars: [
      ...
      { title: "한국어 교육", body: "생활·연습실·현장에서 쓰는 실전 한국어 — 여행 회화가 아니라 일하기 위한 언어." },
      { title: "업계 교육", body: "한국 엔터 업계가 실제로 돌아가는 법: 캐스팅 절차, 계약, 페이, 현장 매너." },
      { title: "E-6-1 비자 지원", body: "합법적으로 공연하고 보수를 받을 수 있는 E-6-1(예술흥행) 비자 준비·신청을 지원." },
      { title: "deetz 실무 투입", body: "뮤직비디오·무대·공연 — deetz 캐스팅 풀과 GRIGO 네트워크로, 수업으로 끝나지 않고 첫 크레딧까지." },
    ],
    howTitle: "진행 방식",
    steps: [
      { title: "지원 — 무료", body: "경력·레벨·비자 상태·시기를 담은 짧은 지원서." },
      { title: "상담", body: "케이스를 검토해 트레이닝·언어·서류·일정 트랙을 설계." },
      { title: "트레이닝·준비", body: "댄스+한국어+업계 교육, 동시에 비자 서류 준비." },
      { title: "실무 투입", body: "deetz를 통한 캐스팅 — 계약은 반드시 서면으로." },
    ],
    protectTitle: "댄서를 지킵니다",
    protectBody: "이 업계엔 정산 문제가 있습니다. deetz는 그걸 바꾸려고 만들어졌고, 프로그램도 같은 원칙으로 돌아갑니다:",
    protectPoints: [
      "모든 일은 서면 계약 — 페이·일정·NDA 조건 명시 (계약 주체: (주)그리고엔터테인먼트).",
      "비용은 투명하게 — 결정 전에 무엇에 얼마가 드는지 명확히 안내.",
      "미수 정산은 진지하게 — 클라이언트가 댄서에게 지급하지 않으면, 함께 싸웁니다.",
    ],
    whoTitle: "누가 운영하나요",
    ...
    faqs: [
      ...
      { q: "실력이 어느 정도여야 하나요?", a: "모든 지원서를 검토합니다 — 레벨·가능성·목표. 완성된 프로일 필요는 없어요. 진지하면 됩니다." },
