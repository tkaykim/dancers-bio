...
const COPY = {
  en: {
    ...
    cta: "Complete my case information",
    ...
    lines: (name) => [
      ...
      "The estimated ₩4,000,000 fee includes dance training, audition-related costs, contract preparation, and administrative handling for the visa process.",
      "The final amount may be lower or higher after the online consultation.",
  ...
  ja: {
    ...
    lines: (name) => [
      ...
      "想定料金400万ウォンには、ダンストレーニング、オーディション関連費用、契約書作成、ビザ発給のための行政手続き費用が含まれます。",
      "オンライン相談後、費用が下がる場合も上がる場合もあります。",
  ...
  ko: {
    ...
    lines: (name) => [
      ...
      "예상 단가 400만원에는 댄스 트레이닝, 오디션 비용, 계약서 작성, 비자 발급을 위한 행정 처리 비용이 포함됩니다.",
      "온라인 상담 후 비용이 더 낮아지거나 올라갈 수 있습니다.",
